					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<a href="mahasiswa_tambah.php" class="btn btn-success">Tambah</a>
							</div>
										...
										<?php
											...
											while($data = mysqli_fetch_array($ress)) {
												...
												echo '<td class="text-center">
													  ...
													  <a href="mahasiswa_edit.php?npp='. $data['npp'] .'" class="btn btn-warning btn-xs">Edit</a>';?>
													  <a href="mahasiswa_hapus.php?npp=<?php echo $data['npp'];?>" onclick="return confirm('Apakah anda yakin akan menghapus <?php echo $data['nama_emp'];?>?');" class="btn btn-danger btn-xs">Hapus</a></td>
												<?php
													  echo '</td>';
												echo '</tr>';												
												$i++;
...
<script type="text/javascript">
	...
	<script>
		...
		$('[data-load-code]').on('click',function(e) {
					...
					if(code) {
						$($this.data('remote-target')).load('mahasiswa_detail.php?code='+code);
						app.code = code;
