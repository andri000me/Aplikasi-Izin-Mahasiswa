...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<form class="form-horizontal" action="mahasiswa_update.php" method="POST" enctype="multipart/form-data">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="control-label col-sm-3">NIM Baru (Abaikan jika tidak diubah)</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="control-label col-sm-3">T</label>
										<div class="col-sm-4">
