...
<!-- top of file -->
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Data Menunggu Approval Perizinan</h1>
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
					...
					<div class="col-lg-12">
						...
						<?php
								$sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.npp=employee.npp AND 
										cuti.stt_cuti='Menunggu Approval Staff BAAK' ORDER BY cuti.tgl_pengajuan DESC";
...
<script type="text/javascript">
	...
	<script>
		...
		$('[data-load-npp]').on('click',function(e) {
					...
					if(npp) {
						$($this.data('remote-target')).load('mahasiswa_detail.php?code='+npp);
						app.npp = npp;
