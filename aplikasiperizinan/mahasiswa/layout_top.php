        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="../libs/images/logodepan.png" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>Universitas Darussalam Gontor</strong></div>
            ...
            <ul class="nav navbar-top-links navbar-right">
				<li class="dropdown dropdown-right">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<img src="libs/images/ico.png" width="20px"></i>&nbsp;<?php echo ucfirst($sess_mngname); ?>&nbsp;<i class="fa fa-caret-down"></i>
					</a>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Sistem Informasi Pengajuan Perizinan Mahasiswa <br> <b>Universitas Darussalam Gontor</b></h4>
						...
						?>
							...
							<a href="#"><i class="fa fa-recycle fa-fw"></i>&nbsp;Pengajuan Perizinan<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									...
									if($pagedesc == "Menunggu Approval") {
										echo '<li><a href="izin_waitapp.php" class="active">Menunggu Approval</a></li>';
									}
									else {
										echo '<li><a href="izin_waitapp.php">Menunggu Approval</a></li>';
									}
									if($pagedesc == "Rejected") {
										echo '<li><a href="izin_reject.php" class="active">Rejected</a></li>';
									}
									else {
										echo '<li><a href="izin_reject.php">Rejected</a></li>';
									}
									if($pagedesc == "Approved") {
										echo '<li><a href="izin_app.php" class="active">Approved</a></li>';
									}
									else {
										echo '<li><a href="izin_app.php">Approved</a></li>';
									}
								?>
							</ul>
						</li>
