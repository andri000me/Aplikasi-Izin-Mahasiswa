				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="libs/images/logodepan.png" alt="logo-dkm" width="70" />
						</td>
						<td class="text-center" width="60%">
						<b>UNIVERSITAS DARUSSA LAM GONTOR</b> <br>
						Jl. Raya Siman No.Km. 6, Dusun Demangan, Siman, Kec. Siman, Kabupaten Ponorogo, Jawa Timur 63471<br>
						Telp: (0352) 483762<br>
						<td class="text-right" width="20%">
							<img src="libs/images/unida.png" alt="logo-dkm" width="70" height="70"/>
						</td>
					</tr>
				</tbody>
			</table>
...
<br/>
	<section id="body-of-report">
		<div class="container-fluid">
			<h4 class="text-center">FORM PENGAJUAN PERIZINAN (APPROVED)</h4>
			<br />
			<br />
