                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						?>
							...
							<a href="#"><i class="fa fa-group fa-fw"></i>&nbsp;Data Mahasiswa<span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<?php
									if($pagedesc == "Data Mahasiswa") {
										echo '<li><a href="karyawan.php" class="active">Data Mahasiswa</a></li>';
									}
									else {
										echo '<li><a href="karyawan.php">Data Mahasiswa</a></li>';
									}
								?>
							</ul>
						</li-->
